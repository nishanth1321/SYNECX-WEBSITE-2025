...
const blogData = [
  {
    ...
    content: ["Web development is evolving rapidly...", "New frameworks are emerging..."],
    type: "standard", // Different types for different UI layouts
    image: "/blogs.svg",
  },
  {
    ...
    content:
      "Using TypeScript with React enhances type safety and improves code maintainability...",
    image: "/blogs.svg",
  },
  {
    ...
    content:
      "Tailwind CSS provides utility-first styling, allowing developers to build beautiful UIs with minimal CSS...",
    image: "/blogs.svg",
  },
  {
    ...
    content:
      "Scalability is key in modern applications, ensuring performance under heavy load...",
    image: "/blogs.svg",
  },
];
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto py-12 px-6">
        ...
        <p className="text-black mt-4 text-lg">{blog.content}</p>
      </div>
    </div>
  );
};
