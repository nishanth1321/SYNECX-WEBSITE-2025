...
export default function Manufacturing() {
  return (
    <div className="bg-white py-16 flex flex-col lg:flex-row items-center justify-center px-4 lg:px-60">
      <div className="w-full lg:w-1/2 flex flex-col items-start justify-center text-left space-y-6 mb-12 lg:mb-0">
        <h2 className="text-indigo-500 text-lg font-medium mt-2">
      ...
      <div className="relative w-full lg:w-1/2 flex justify-center lg:justify-end">
        <div className="relative w-[200px] h-[400px] sm:w-[250px] sm:h-[450px] lg:w-[300px] lg:h-[550px]">
          <div className="absolute -left-10 -bottom-6 w-[400px] h-[350px] bg-gradient-to-r from-pink-500 to-orange-300 rounded-3xl"></div>
          <div className="absolute -top-10 right-10 w-[50px] h-[50px] rounded-full bg-pink-100"></div>
          <div className="absolute -bottom-4 -right-10 w-[80px] h-[80px] rounded-full bg-gradient-to-r from-pink-500 to-orange-300"></div>
