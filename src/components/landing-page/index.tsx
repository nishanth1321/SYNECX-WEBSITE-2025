  ...
  return (
    <div>
      ...
      <div className="relative min-h-screen">
        ...
        {/* Main Content */}
        <div className="relative min-h-screen grid grid-cols-1 lg:grid-cols-2 items-center justify-center bg-white/30 backdrop-blur-sm px-6 lg:px-28">
          {/* Image Section (Moves to Top Only on Mobile) */}
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end bg-green-200">
            <div className="relative sm:-right-32 mt-6 sm:mt-0 left-0 sm:left-11">
              <Image
                src="/landingheader.svg"
                alt="Phone preview"
          ...
          {/* Text Section */}
          <div className="order-2 lg:order-1 text-center bg-white/70 lg:text-left max-w-xl mb-12 lg:mb-0 lg:mr-8 md:mb-5 mt-6 sm:mt-0 rounded-xl">
            <h2 className="text-lg lg:text-lg font-medium text-gray-600 mb-4 lg:mb-2 py-4 pl-6">
              Revolutionizing Industries with AI-Powered Solutions
            </h2>
            <h1 className="text-3xl lg:text-5xl font-semibold text-gray-900 mb-6 lg:mb-8 pl-6">
