...
const QuotationForm: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-12 mt-24">
      {/* Left Section - Form */}
      ...
      <div className="text-left sm:mx-0 mx-6">
          ...
          <div className="flex items-start mt-10">
            <div className="flex-shrink-0 h-8 w-8 flex items-center justify-center rounded-full bg-blue-500 text-white font-bold mr-4">
              <FaChartBar />
            </div>
            <div>
  ...
  <form
    ...
    className="bg-white shadow-lg rounded px-8 pt-6 pb-8 w-full max-w-full shadow-cyan-100 "
  >
    <h2 className="text-2xl font-bold mb-6 text-center text-gray-700">
      Request your quotation here
    </h2>

    {/* First Name and Last Name (same row on larger screens) */}
    <div className="flex flex-wrap gap-4 mb-4">
      <div className="flex-1 min-w-[48%]">
        ...
        <input
          ...
          required
          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:ring-cyan-100"
        />
      </div>
      <div className="flex-1 min-w-[48%]">
        <label
    ...
    {/* Email and Phone Number (same row on larger screens) */}
    <div className="flex flex-wrap gap-4 mb-4">
      <div className="flex-1 min-w-[48%]">
        <label
          htmlFor="email"
    ...
    {/* Company Name and Business Type (same row on larger screens) */}
    <div className="flex flex-wrap gap-4 mb-4">
      <div className="flex-1 min-w-[48%]">
        <label
          htmlFor="company"
    ...
    {/* Branches Count and Location (same row on larger screens) */}
    <div className="flex flex-wrap gap-4 mb-4">
      <div className="flex-1 min-w-[48%]">
        <label
    ...
    <div className="flex items-center justify-center">
      <button
        ...
        className={`bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-cyan-100 ${
