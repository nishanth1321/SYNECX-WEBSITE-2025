      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-12">
        ...
        <div className="lg:w-1/2">
          <div className="text-left">
            <h1 className="text-blue-600 font-medium">Answeres to</h1>
            <h2 className="text-3xl font-semibold text-gray-900">
              Frequently Asked Questions
            </h2>
            <p className="mt-4 text-gray-600">
              Our FAQ section offers quick answers to common questions about
              Sycnex AI Labs&apos; services and processes, providing the
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-200">
              ...
              >
                ...
                <div className="ml-4 bg-blue-500 text-white rounded-full w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center">
